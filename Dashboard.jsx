...
function GettingStartedChecklist({ inventory, crm, invoices, expenses, posTransactions, onNavigate }) {
...
function BusinessHealthCard({ invoices, inventory, expenses, posTransactions }) {
...
function IndustryInsights({ company, onNavigate }) {
  const [dismissed, setDismissed] = useState(false);
