                ...
                {catData.length===0?<p className="text-slate-400 text-center py-6">No stock data</p>:(
                  <div className="flex items-center gap-4">
                    <ResponsiveContainer width="55%" height={150}>
                      <RPieChart><Pie data={catData} dataKey="value" cx="50%" cy="50%" outerRadius={60} innerRadius={30}>
                        {catData.map((d,i)=><Cell key={i} fill={d.fill}/>)}
                      </Pie><Tooltip formatter={(v,n)=>[v+" units",n]}/></RPieChart>
                    </ResponsiveContainer>
...
export default PharmacyManagementModule;
